...
public class Homework03Server {
    public static void main(String[] args) throws Exception {
        ...
        if("高山流水".equals(downLoadFileName)) {
            resFileName = "E:\\Project\\Java\\JavaStudy\\JavaBasicKnowledge\\chapter21\\src\\高山流水.mp3";
        } else {
            resFileName = "E:\\Project\\Java\\JavaStudy\\JavaBasicKnowledge\\chapter21\\src\\无名.mp3";
        }
